  ...
  const handleSend = () => {
    ...
    setTimeout(() => {
      ...
      if (lowerInput.includes('kosten') || lowerInput.includes('preis') || lowerInput.includes('teuer')) {
        ...
        botResponse = "Wir planen Ihren Garten sorgfältig und detailliert, damit jedes Detail Ihren Vorstellungen entspricht.";
        ...
        botResponse = "Sie erreichen uns telefonisch unter 03377 205458 oder per E-Mail an jute-galabau@web.de. Wir freuen uns auf Sie!";
