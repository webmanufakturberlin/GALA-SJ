    ...
    <footer className="bg-forest text-cream pt-24 pb-12 relative z-10 border-t border-cream/10">
      <div className="section-container">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          >
            <h2 className="text-3xl font-serif mb-6">Jute Garten- und Landschaftsbau</h2>
          ...
          >
            ...
            <ul className="space-y-3 font-sans text-sm text-cream/80">
              ...
              <li className="pt-2">
                <a href="tel:03377205458" className="hover:text-bronze transition-colors">
                  03377 205458
                </a>
              </li>
              <li>
                <a href="mailto:jute-galabau@web.de" className="hover:text-bronze transition-colors">
                  jute-galabau@web.de
                </a>
              </li>
            </ul>
        ...
        <motion.div
          ...
          <p>&copy; 2026 Jute Garten- und Landschaftsbau. Alle Rechte vorbehalten.</p>
