...
const boxes = [
  ...
  {
    title: 'Jahre Expertise in Zossen',
    number: 20,
    suffix: '+',
  ...
  },
  {
    ...
    desc: 'Inhaber Sascha Junker begleitet Ihr Projekt von der ersten Ideenskizze bis zur schlüsselfertigen Übergabe - für maximale Transparenz und Vertrauen.',
    icon: UserCheck,
    iconName: 'UserCheck',
