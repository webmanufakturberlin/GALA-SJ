            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-forest/70 font-sans text-sm">Johnepark 49, 15806 Zossen</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="tel:03377205458" className="text-forest/70 font-sans text-sm hover:text-bronze transition-colors">
                    03377 205458
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="mailto:jute-galabau@web.de" className="text-forest/70 font-sans text-sm hover:text-bronze transition-colors">
                    jute-galabau@web.de
                  </a>
                </div>
              </div>
